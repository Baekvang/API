...
class SQLi {
	...
	public function escapeString($hConnectionID, $string) {
		if (!is_string($string)) {
			return null;
			//echo "This should be a string !! <pre>";print_r($string);
		}
		$escapedString = mysqli_real_escape_string($hConnectionID, trim($string));
